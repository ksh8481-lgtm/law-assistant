...
2. 당신이 자체 지식이나 구글 검색으로 판례나 법령을 추가 인용할 때는 아래의 정확한 검색 파라미터(`query=`)를 사용하십시오.
  - ⚖️ 법령 링크: `[법령명](https://www.law.go.kr/LSW/lsSc.do?query=법령명)` (예: `[건설산업기본법](https://www.law.go.kr/LSW/lsSc.do?query=건설산업기본법)`)
  - ⚖️ 판례 링크: `[사건번호](https://www.law.go.kr/LSW/precSc.do?query=사건번호)` (예: `[2014다87955](https://www.law.go.kr/LSW/precSc.do?query=2014다87955)`)
